...
<div>
  <div class ="popup-content info">
    ...
    <div id="popup-buttons">
      <button type="button" class="agree-button"><i class="icon-arrow-right"></i><?php print $agree_button ?></button>
      <button type="button" class="find-more-button"><i class="icon-arrow-right"></i><?php print $disagree_button; ?></button>
    </div>
  </div>
</div>
